...
const tc02Data = {
    ...
    indicators: [
        ...
        { id: "CT2.6.2", order: 10, name: "2. Tỷ lệ kinh phí được bảo đảm để thực hiện các nhiệm vụ phổ biến, giáo dục pháp luật trong kế hoạch", description: "...", evidenceRequirement: "...", standardLevel: "...", inputType: "percentage_ratio", parentCriterionId: "TC02", originalParentIndicatorId: "CT2.6" }, // Đổi thành percentage_ratio
        { id: "CT2.6.3", order: 11, name: "3. Tỷ lệ tuyên truyền viên pháp luật được tập huấn, bồi dưỡng kiến thức pháp luật", description: "...", evidenceRequirement: "...", standardLevel: "...", inputType: "percentage_ratio", parentCriterionId: "TC02", originalParentIndicatorId: "CT2.6" }, // Đổi thành percentage_ratio
