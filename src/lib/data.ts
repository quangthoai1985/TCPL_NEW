...
export type IndicatorResult = {
  ...
  value: any;
  name?: string, // Made optional as it might not be there
  url?: string,
  ...
  files?: { // Added files array which was referenced in page.tsx
    name: string,
    url?: string,
    signatureStatus?: 'validating' | 'valid' | 'invalid' | 'error' | null;
    signatureError?: string | null;
...
export type Indicator = {
  ...
  inputType: 'number' | 'boolean' | 'select' | 'text' | 'percentage_ratio' | 'checkbox_group' | 'TC1_like' | 'group_header';
